...
public class GiraffePlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config == null || TextUtils.isEmpty(config.url)) {
            ...
            onPlayerListener.onPlayer(player);
        }
    }
    ...
    private static OnPlayerListener onPlayerListener=new OnPlayerListener(){
        @Override
    ...
    public interface OnPlayerListener{
        void onPlayer(GiraffePlayer player);
    }
    ...
    public static class Config implements Parcelable {
        ...
        public Config setShowNavIcon(boolean showNavIcon) {
        ...
        public Config onPlayer(OnPlayerListener onPlayerListener) {
            GiraffePlayerActivity.onPlayerListener = onPlayerListener;
            return this;
        }
